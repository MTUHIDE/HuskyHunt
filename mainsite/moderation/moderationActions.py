...
def remove_item(queryset, reason):
    ...
    for item in queryset:
        ...
        moderationReport = ItemModerationActions(item_id=item, action_type=ModerationActionType.Types.REMOVE,
                                                 reason=reason)
...
def remove_ride(queryset, reason):
    ...
    for ride in queryset:
        ...
        moderationReport = RideModerationActions(ride_id=ride, action_type=ModerationActionType.Types.REMOVE,
                                                 reason=reason)
        moderationReport.save()
