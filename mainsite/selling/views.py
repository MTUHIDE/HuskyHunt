...
def index(request):
    ...
    MANUAL_REVIEW_THRESHOLD = -1  # This is the number of points a user must exceed to be "verified" and not require
    ...
    if request.method == 'POST':
        ...
        if submission_type == ['ride'] and num_ride_items < MAX_RIDE_ITEMS:
            ...
            if ride_form.is_valid():
                ...
                ride_item.destination_coordinates_lat, ride_item.destination_coordinates_lon = getLocationByRequest(
                    ride_item)
